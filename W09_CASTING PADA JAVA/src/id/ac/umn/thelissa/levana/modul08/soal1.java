package id.ac.umn.thelissa.levana.modul08;

import id.ac.umn.thelissa.levana.modul08.Model.Barang;
import id.ac.umn.thelissa.levana.modul08.Model.Handphone;
import id.ac.umn.thelissa.levana.modul08.Model.Voucher;
import id.ac.umn.thelissa.levana.modul08.Model.Order;
...
public class soal1 {
    ...
    private static void pesanBarang(List<Handphone> handphones, List<Voucher> vouchers, List<Order> orders,
        ...
        if (choice == 1) {
            ...
            for (Handphone handphone : handphones) {
                if (handphone.getId().equals(idBarang)) {
            ...
            for (Voucher voucher : vouchers) {
                if (voucher.getId().equals(idBarang)) {
